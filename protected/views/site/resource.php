...
<div class="resource-data resource-info-source resource-bar <?= $resource->primary ? 'primary' : '' ?>" res-id="<?= $resource->id ?>" organ-id="<?= $organ->id ?>" max-shown="<?= $resource->max_shown_value ?>" init="no" name="<?= $resource->name ?>" aliases="<?= $resource->getNames() ?>">
    <div class="progress">
