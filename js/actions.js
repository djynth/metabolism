...
function getAction(id)
{
    ...
    case 16: return new Action("Pyruvate Dehydrogenase",                  id, 0,  -1, [LIVER, MUSCLE, BRAIN], [{res: 'NAD+',  val: -1},  {res: 'NADH',  val:  1},  {res: 'CO2',   val:  1}, {res: 'HSCoA', val: -1}, {res: 'Acetyl-CoA', val:  1},  {res: 'Pyr',     val: -1}],                                                                                                                                    true);
